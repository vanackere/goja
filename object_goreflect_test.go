...
func (fieldNameMapper1) SkipValue(t reflect.Type, field reflect.StructField) func(v reflect.Value) bool {
	return nil
}
...
func (testFieldMapper) SkipValue(t reflect.Type, field reflect.StructField) func(v reflect.Value) bool {
	return nil
}
